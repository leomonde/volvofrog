...
void ExperimentalButton::paintEvent(QPaintEvent *event) {
  ...
  if (!scene.rotating_wheel) {
    ...
    QColor background_color = steeringWheel ? (experimental_mode ? QColor(218, 111, 37, 241) : scene.navigate_on_openpilot ? QColor(49, 161, 238, 255) : QColor(0, 0, 0, 166)) : QColor(0, 0, 0, 166);
...
void AnnotatedCameraWidget::drawHud(QPainter &p) {
  ...
  if (rotatingWheel) {
    ...
    QColor background_color = steeringWheel ? (experimentalMode ? QColor(218, 111, 37, 241) : scene.navigate_on_openpilot ? QColor(49, 161, 238, 255) : QColor(0, 0, 0, 166)) : QColor(0, 0, 0, 166);
