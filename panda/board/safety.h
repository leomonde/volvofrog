...
void generic_rx_checks(bool stock_ecu_detected) {
  ...
  //vp if (!(alternative_experience & ALT_EXP_ALWAYS_ON_LATERAL)) {
...
bool steer_torque_cmd_checks(int desired_torque, int steer_req, const SteeringLimits limits) {
  ...
  //vp if (lateral_controls_allowed) {
  if (controls_allowed) {
  ...
  //vp if (!lateral_controls_allowed && (desired_torque != 0)) {
  ...
  //vp if (violation || !lateral_controls_allowed) {
...
bool steer_angle_cmd_checks(int desired_angle, bool steer_control_enabled, const SteeringLimits limits) {
  ...
  //vp if (lateral_controls_allowed && steer_control_enabled) {
  ...
  //vp violation |= !lateral_controls_allowed && steer_control_enabled;
